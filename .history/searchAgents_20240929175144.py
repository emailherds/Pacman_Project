    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                if new_position in self.corners and new_position not in corners_visited:
                    new_corners_visited = tuple(list(corners_visited) + [new_position])


                successor = ((new_position, new_corners_visited), action, 1)
